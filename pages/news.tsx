      ...
      <div className={`${styles.container} ${isDarkMode ? styles.darkMode : ""}`}>
        <header className={styles.header}>
          <div className={styles.headerContent}>
            <div>
              <h1 className={styles.logo}>Digital News Web</h1>
            </div>
            <h3 className={styles.logo_another}>The best place to get the latest news and updates</h3>
          </div>
        ...
        <footer className={styles.footer}>
          <p>
            &copy; {new Date().getFullYear()} Digital News Web | API from Currents, Mediastack, and NewsAPI
          </p>
        </footer>
      </div>
    </>
